...
// ─── Receipt Modal ─────────────────────────────────────────────────────────────
function downloadReceiptHtml(tx: Transaction, business: any, currency: string, subtotal: number, tax: number, vatRate: number, staffName: string, customerName: string) {
      ...
      <div className="modal-box" style={{ maxWidth: 440 }}>
        ...
        <div id="receipt-print-area" className="receipt-container">
          ...
          <div className="receipt-meta-grid">
            ...
            <div className="receipt-meta-item right">
              ...
              <span className="receipt-meta-badge">
                PAID
              </span>
            </div>
            <div className="receipt-meta-item">
          ...
          <table className="receipt-table">
            ...
            <tbody>
              {tx.items?.map((item) => (
                <tr key={item.id}>
                  <td style={{ textAlign: "left", fontWeight: 700, color: "#000000" }}>
                    {item.product?.name}
                  </td>
        ...
        <div className="modal-footer no-print">
          ...
          <button
            ...
            onClick={() => downloadReceiptHtml(tx, business, currency, subtotal, tax, vatRate, staffName, customerName)}
          >
